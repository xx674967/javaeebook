...
<html>
  <head>
	...
	-->
	<link rel="stylesheet" type="text/css" href='<%=request.getContextPath()%>/adminjsps/admin/css/book/left.css'/>
	<script type="text/javascript" src='<%=request.getContextPath()%>/jquery/jquery-1.5.1.js'></script>
	<script type="text/javascript" src='<%=request.getContextPath()%>/menu/mymenu.js'></script>
	<link rel="stylesheet" href='<%=request.getContextPath()%>/menu/mymenu.css' type="text/css" media="all"/>
